...
echo "$($PSQL "SELECT DISTINCT t.name FROM teams AS t INNER JOIN games AS g ON t.team_id = g.winner_id OR t.team_id = g.opponent_id WHERE g.year = 2014  AND g.round = 'Eighth-Final'")"
